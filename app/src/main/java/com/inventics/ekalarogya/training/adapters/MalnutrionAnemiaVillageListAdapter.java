...
import com.inventics.ekalarogya.training.main.dashotheractivity.malnutrition.animea.AnemiaCheckup;
import com.inventics.ekalarogya.training.models.VillageListModel;

import java.util.List;

public class MalnutrionAnemiaVillageListAdapter extends RecyclerView.Adapter<MalnutrionAnemiaVillageListAdapter.ViewHolder> {
    ...
    private MalnutrionAnemiaVillageListAdapter.OnItemClickListener listener;
    ...
    public MalnutrionAnemiaVillageListAdapter(Context context, List<VillageListModel> villageListModel) {
    ...
    @NonNull
    @Override
    public MalnutrionAnemiaVillageListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(mContaxt);
        View view = inflater.inflate(R.layout.row_listing, null);
        return new MalnutrionAnemiaVillageListAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final MalnutrionAnemiaVillageListAdapter.ViewHolder holder, int position) {
...
//        Picasso.with(mContaxt).load(baseResponse.getPath()).placeholder(R.drawable.arogya_vector).error(R.drawable.arogya_vector).into(holder.dash_imagee);
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public void bind(VillageListModel villageListModel, MalnutrionAnemiaVillageListAdapter.OnItemClickListener listener, int position) {
            llBody.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Log.d(TAG, "onClick: edit"+villageListModel.getVillage_id()+"\n");;
                    Intent intent=new Intent(mContaxt, AnemiaCheckup.class);

...
import com.inventics.ekalarogya.training.main.dashotheractivity.malnutrition.malnutrion.MalnutrionCheckupAdd;
import com.inventics.ekalarogya.training.models.FamilyMembersModel;

import java.util.List;

public class MalnutrionFamilyMemberAdapter extends RecyclerView.Adapter<MalnutrionFamilyMemberAdapter.ViewHolder> {
    ...
    private MalnutrionFamilyMemberAdapter.OnItemClickListener listener;
    String headid,v_id;
    ...
    public MalnutrionFamilyMemberAdapter(Context context, String head_id,String v_id, List<FamilyMembersModel>familyMemberListModelList) {
    ...
    @NonNull
    @Override
    public MalnutrionFamilyMemberAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(mContaxt);
        View view = inflater.inflate(R.layout.row_member, null);

        return new MalnutrionFamilyMemberAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final MalnutrionFamilyMemberAdapter.ViewHolder holder, int position) {
...
//        Picasso.with(mContaxt).load(baseResponse.getPath()).placeholder(R.drawable.arogya_vector).error(R.drawable.arogya_vector).into(holder.dash_imagee);
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public void bind(FamilyMembersModel familyMemberListModelList, MalnutrionFamilyMemberAdapter.OnItemClickListener listener, int position) {

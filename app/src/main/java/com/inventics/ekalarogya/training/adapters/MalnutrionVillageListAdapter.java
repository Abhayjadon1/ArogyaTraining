...
import com.inventics.ekalarogya.training.main.dashotheractivity.malnutrition.malnutrion.MalnutritionCheckup;
import com.inventics.ekalarogya.training.models.VillageListModel;

import java.util.List;

public class MalnutrionVillageListAdapter  extends RecyclerView.Adapter<MalnutrionVillageListAdapter.ViewHolder> {
    ...
    private MalnutrionVillageListAdapter.OnItemClickListener listener;
    ...
    public MalnutrionVillageListAdapter(Context context, List<VillageListModel> villageListModel) {
    ...
    @NonNull
    @Override
    public MalnutrionVillageListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(mContaxt);
        View view = inflater.inflate(R.layout.row_listing, null);
        return new MalnutrionVillageListAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final MalnutrionVillageListAdapter.ViewHolder holder, int position) {
...
//        Picasso.with(mContaxt).load(baseResponse.getPath()).placeholder(R.drawable.arogya_vector).error(R.drawable.arogya_vector).into(holder.dash_imagee);
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public void bind(VillageListModel villageListModel, MalnutrionVillageListAdapter.OnItemClickListener listener, int position) {
            llBody.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Log.d(TAG, "onClick: edit"+villageListModel.getVillage_id()+"\n");;
                    Intent intent=new Intent(mContaxt, MalnutritionCheckup.class);
                    intent.putExtra("type","vill");
                    intent.putExtra("v_data",villageListModel);

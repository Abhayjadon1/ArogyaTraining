...
import com.inventics.ekalarogya.training.main.dashotheractivity.herbalremedies.medicinegarden.MedicineGarden;
import com.inventics.ekalarogya.training.models.VillageListModel;

import java.util.List;

public class MedicineGardenVillageListAdapter extends RecyclerView.Adapter<MedicineGardenVillageListAdapter.ViewHolder> {
...
private MedicineGardenVillageListAdapter.OnItemClickListener listener;
...
public interface OnItemClickListener {
    ...
    public MedicineGardenVillageListAdapter(Context context, List<VillageListModel> villageListModel) {
    ...
    @NonNull
    @Override
    public MedicineGardenVillageListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(mContaxt);
        View view = inflater.inflate(R.layout.row_listing, null);
        return new MedicineGardenVillageListAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final MedicineGardenVillageListAdapter.ViewHolder holder, int position) {
...
class ViewHolder extends RecyclerView.ViewHolder{
    ...
    public void bind(VillageListModel villageListModel, MedicineGardenVillageListAdapter.OnItemClickListener listener, int position) {
        llBody.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Log.d(TAG, "onClick: edit"+villageListModel.getVillage_id()+"\n");;
                Intent intent=new Intent(mContaxt, MedicineGarden.class);

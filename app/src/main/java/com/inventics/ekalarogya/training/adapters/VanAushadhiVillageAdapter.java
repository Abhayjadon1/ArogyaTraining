...
import com.inventics.ekalarogya.training.main.dashotheractivity.herbalremedies.medprep.VanAushadhi;
import com.inventics.ekalarogya.training.models.VillageListModel;

import java.util.List;

public class VanAushadhiVillageAdapter  extends RecyclerView.Adapter<VanAushadhiVillageAdapter.ViewHolder> {
    ...
    private VanAushadhiVillageAdapter.OnItemClickListener listener;
    ...
    public VanAushadhiVillageAdapter(Context context, List<VillageListModel> villageListModel) {
    ...
    @NonNull
    @Override
    public VanAushadhiVillageAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(mContaxt);
        View view = inflater.inflate(R.layout.row_listing, null);
        return new VanAushadhiVillageAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final VanAushadhiVillageAdapter.ViewHolder holder, int position) {
...
//        Picasso.with(mContaxt).load(baseResponse.getPath()).placeholder(R.drawable.arogya_vector).error(R.drawable.arogya_vector).into(holder.dash_imagee);
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public void bind(VillageListModel villageListModel, VanAushadhiVillageAdapter.OnItemClickListener listener, int position) {
            llBody.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Log.d(TAG, "onClick: edit"+villageListModel.getVillage_id()+"\n");;
                    Intent intent=new Intent(mContaxt, VanAushadhi.class);

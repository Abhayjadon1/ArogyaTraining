...
public class MemberArrayListAdapter  extends ArrayAdapter<FamilyMembersModel> {

    public MemberArrayListAdapter(Context context,
                                   List<FamilyMembersModel> villageListModel)
    {
                          ...
                          ViewGroup parent)
    {
        ...
        FamilyMembersModel currentItem = getItem(position);

package com.inventics.ekalarogya.training.custom_views;
...
/**
 * Created by sonu on 17:20, 08/10/18
...
public class OTPInputView extends AppCompatEditText {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (!isInEditMode()) {
            ...
            context.getTheme().resolveAttribute(R.color.colorPrimaryDark,
                    outValue, true);
            final int colorActivated = outValue.data;
            mColors[0] = colorActivated;

            context.getTheme().resolveAttribute(R.color.black,
                    outValue, true);

...
import com.inventics.ekalarogya.training.adapters.MedicineGardenFamilyAdapter;
...
public class MedicineGardenFamily extends AppCompatActivity implements RetroAPICallback {
    ...
    private static final String TAG = MedicineGardenFamily.class.getSimpleName();
...
//                startActivity(new Intent(SocialSanitisation.this, Preventive.class));
        ...
        GridLayoutManager gridLayoutManager = new GridLayoutManager(MedicineGardenFamily.this, 1);
    ...
    private void getVillageChildList() {//1:Member listing with head included , 2:Member listing with head excluded
        UserService.getVillageFamilyMembersList(MedicineGardenFamily.this,v_id,h_id,"1",this,MEMBER_ANIM_REQUEST_CODE);

    }

    private void getVillageheadList(String v_id) {
        UserService.getVillageHeadList(MedicineGardenFamily.this,v_id,searchData,page,this,VILLAGE_FAMILY_REQUEST_CODE);
...
//                                firstAidFamilyMemberAdapter = new FirstAidFamilyMemberAdapter(MedicineGardenFamily.this,id,baseResponseModule.getFamilyMemberListModels());
...
//                        if(villageFamilyAdapter!=null&&villageFamilyAdapter.getItemCount()==0){
                        ...
                        if (baseResponseModule.getStatus().equalsIgnoreCase(RestUtils.SUCCESS)) {
                            ...
                            if (!(baseResponseModule.getVillageFamilyModelList().size() > 0)) {
                                ...
                                if (page > 1) {
                                    ...
                                    villageMobileList.addAll(baseResponseModule.getVillageFamilyModelList());
                                    villageFamilyAdapter = new MedicineGardenFamilyAdapter(MedicineGardenFamily.this,v_id, villageMobileList);

...
public class ExtraUtils {
    ...
    public static final String baseImg= BuildConfig.STAGING_END_POINT;
    public static final String type= "type";
    public static final String imgURL= BuildConfig.STAGING_END_POINT;
    public static final String typeView= "edit";
    public static final String typeEdit= "view";

...
public class ArogyaCampVillageListAdpater  extends RecyclerView.Adapter<ArogyaCampVillageListAdpater.ViewHolder> {
    ...
    private ArogyaCampVillageListAdpater.OnItemClickListener listener;
    ...
    public ArogyaCampVillageListAdpater(Context context, List<VillageListModel> villageListModel) {
    ...
    @NonNull
    @Override
    public ArogyaCampVillageListAdpater.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(mContaxt);
        View view = inflater.inflate(R.layout.row_listing, null);
        return new ArogyaCampVillageListAdpater.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final ArogyaCampVillageListAdpater.ViewHolder holder, int position) {
...
//        Picasso.with(mContaxt).load(baseResponse.getPath()).placeholder(R.drawable.arogya_vector).error(R.drawable.arogya_vector).error(R.drawable.add_image).into(holder.dash_imagee);
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public void bind(VillageListModel villageListModel, ArogyaCampVillageListAdpater.OnItemClickListener listener, int position) {
            llBody.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Log.d(TAG, "onClick: edit"+villageListModel.getVillage_id()+"\n");;
                    Intent intent=new Intent(mContaxt, ArogyaCamp.class);

...
import com.ispl.ekalarogya.training.main.dashotheractivity.eye.eyescreening.EyeScreening;
import com.ispl.ekalarogya.training.models.VillageListModel;

import java.util.List;

public class EyeScreenVillAdapder  extends RecyclerView.Adapter<EyeScreenVillAdapder.ViewHolder> {
    ...
    private EyeScreenVillAdapder.OnItemClickListener listener;
    ...
    public EyeScreenVillAdapder(Context context, List<VillageListModel> villageListModel) {
    ...
    @NonNull
    @Override
    public EyeScreenVillAdapder.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(mContaxt);
        View view = inflater.inflate(R.layout.row_listing, null);
        return new EyeScreenVillAdapder.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final EyeScreenVillAdapder.ViewHolder holder, int position) {
...
//            vieweye.setVisibility(View.VISIBLE);
        ...
        public void bind(VillageListModel villageListModel, EyeScreenVillAdapder.OnItemClickListener listener, int position) {
            llBody.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Log.d(TAG, "onClick: edit"+villageListModel.getVillage_id()+"\n");;
                    Intent intent=new Intent(mContaxt, EyeScreening.class);

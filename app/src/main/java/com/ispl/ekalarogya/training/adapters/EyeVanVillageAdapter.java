...
import com.ispl.ekalarogya.training.main.dashotheractivity.eye.eyevan.EyeVan;
import com.ispl.ekalarogya.training.models.VillageListModel;

import java.util.List;

public class EyeVanVillageAdapter extends RecyclerView.Adapter<EyeVanVillageAdapter.ViewHolder> {
    ...
    private EyeVanVillageAdapter.OnItemClickListener listener;
    ...
    public EyeVanVillageAdapter(Context context, List<VillageListModel> villageListModel) {
    ...
    @NonNull
    @Override
    public EyeVanVillageAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(mContaxt);
        View view = inflater.inflate(R.layout.row_listing, null);
        return new EyeVanVillageAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final EyeVanVillageAdapter.ViewHolder holder, int position) {
...
//        Picasso.with(mContaxt).load(baseResponse.getPath()).placeholder(R.drawable.arogya_vector).error(R.drawable.arogya_vector).into(holder.dash_imagee);
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public void bind(VillageListModel villageListModel, EyeVanVillageAdapter.OnItemClickListener listener, int position) {
            llBody.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Log.d(TAG, "onClick: edit"+villageListModel.getVillage_id()+"\n");;
                    Intent intent=new Intent(mContaxt, EyeVan.class);

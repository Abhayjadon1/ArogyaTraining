...
public class FirstAidVillageListAdapter  extends RecyclerView.Adapter<FirstAidVillageListAdapter.ViewHolder> {
    ...
    private FirstAidVillageListAdapter.OnItemClickListener listener;
    ...
    public FirstAidVillageListAdapter(Context context, List<VillageListModel> villageListModel) {
    ...
    @NonNull
    @Override
    public FirstAidVillageListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(mContaxt);
        View view = inflater.inflate(R.layout.row_listing, null);
        return new FirstAidVillageListAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final FirstAidVillageListAdapter.ViewHolder holder, int position) {
...
//        Picasso.with(mContaxt).load(baseResponse.getPath()).placeholder(R.drawable.arogya_vector).error(R.drawable.arogya_vector).into(holder.dash_imagee);
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public void bind(VillageListModel villageListModel, FirstAidVillageListAdapter.OnItemClickListener listener, int position) {
            llBody.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Log.d(TAG, "onClick: edit"+villageListModel.getVillage_id()+"\n");;
                    Intent intent=new Intent(mContaxt, FirstAid.class);

...
public class VillageListAdapter  extends RecyclerView.Adapter<VillageListAdapter.ViewHolder> {
    ...
    private VillageListAdapter.OnItemClickListener listener;
    ...
    public VillageListAdapter(Context context, List<VillageListModel> villageListModel) {
    ...
    public VillageListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new VillageListAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final VillageListAdapter.ViewHolder holder, int position) {
...
//            vieweye=itemView.findViewById(R.id.viewbtn);
        ...
        public void bind(VillageListModel villageListModel, VillageListAdapter.OnItemClickListener listener, int position) {
            llBody.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Log.d(TAG, "onClick: edit"+villageListModel.getVillage_id()+"\n");;
                    Intent intent=new Intent(mContaxt, VillageFamily.class);
                    intent.putExtra("type","10");
                    intent.putExtra("id",villageListModel.getVillage_id());
                    intent.putExtra("village_name",villageListModel.getVillage_name());

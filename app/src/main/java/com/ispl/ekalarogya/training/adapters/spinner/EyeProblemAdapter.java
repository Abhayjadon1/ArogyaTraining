...
import com.ispl.ekalarogya.training.models.EyeProblemModel;

import java.util.List;

public class EyeProblemAdapter extends ArrayAdapter<EyeProblemModel> {

    public EyeProblemAdapter(Context context,
                            List<EyeProblemModel> eyeProblemModelList)
    {
        super(context, 0, eyeProblemModelList);
    }
                          ...
                          ViewGroup parent)
    {
        ...
        EyeProblemModel currentItem = getItem(position);

...
public class InspectionAdapter  extends ArrayAdapter<InspectionModel> {

    public InspectionAdapter(Context context, List<InspectionModel> villageListModel) {
    ...
    private View initView(int position, View convertView, ViewGroup parent) {
        ...
        InspectionModel currentItem = getItem(position);

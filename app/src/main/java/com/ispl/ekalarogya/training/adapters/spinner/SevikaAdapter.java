...
public class SevikaAdapter extends ArrayAdapter<SevikaModel> {

    public SevikaAdapter(Context context, List<SevikaModel> villageListModel) {
    ...
    private View initView(int position, View convertView, ViewGroup parent) {
        ...
        SevikaModel currentItem = getItem(position);

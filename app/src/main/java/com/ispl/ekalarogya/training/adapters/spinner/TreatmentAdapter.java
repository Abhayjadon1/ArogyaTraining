...
public class TreatmentAdapter  extends ArrayAdapter<TreatmentTypeModel> {

    public TreatmentAdapter(Context context, List<TreatmentTypeModel> villageListModel) {
    ...
    private View initView(int position, View convertView, ViewGroup parent) {
        ...
        TreatmentTypeModel currentItem = getItem(position);

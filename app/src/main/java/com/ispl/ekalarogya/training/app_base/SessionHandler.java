...
public class SessionHandler {
    ...
    public void saveLong(Context mContext, String key, long value) {
        mContext.getSharedPreferences("GIGS", Context.MODE_PRIVATE).edit().putLong(key, value).commit();
    }
    ...
    public long getLong(Context mContext, String key) {
        return mContext.getSharedPreferences("GIGS", Context.MODE_PRIVATE).getLong(key, 0L);
    }
}

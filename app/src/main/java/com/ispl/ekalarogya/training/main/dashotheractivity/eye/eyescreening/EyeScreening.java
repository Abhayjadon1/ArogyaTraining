package com.ispl.ekalarogya.training.main.dashotheractivity.eye.eyescreening;
...
import com.ispl.ekalarogya.training.adapters.EyeScreenAdapter;
import com.ispl.ekalarogya.training.adapters.EyeScreenVillAdapder;
...
public class EyeScreening extends AppCompatActivity implements RetroAPICallback, View.OnClickListener {
    ...
    private static final String TAG = EyeScreening.class.getSimpleName();
    EyeScreenAdapter eyeScreenAdapter;
    List<EyeVanModel> eyeVanModelList = new ArrayList<>();
    EyeScreenVillAdapder villageListAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GridLayoutManager gridLayoutManager = new GridLayoutManager(EyeScreening.this, 1);
...
//                    break;
                case "10":
                    tv_title.setText(getResources().getString(R.string.eye_screen));
...
//                        getSingleFamilyMedGarden();
        ...
        addMember.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(EyeScreening.this);
                ...
                builder.setItems(animals, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        switch (which) {
                            case 0:
                                Intent intent = new Intent(EyeScreening.this, EyeScreeningAdd.class);
                                intent.putExtra("v_id", v_id);
                                intent.putExtra("type", "add");
                                startActivity(intent);
                                break;
                            case 1: // guest
                                Intent intentg = new Intent(EyeScreening.this, EyeScreeningAdd.class);
                                intentg.putExtra("v_id", v_id);
                                intentg.putExtra("type", "add");
                                intentg.putExtra("member_type", "guest");
...
//                startActivity(new Intent(SocialSanitisation.this, Preventive.class));
    ...
    private void getVillageTreatmentList(String v_id) {
        UserService.getEyeScreeningList(EyeScreening.this,v_id, String.valueOf(flag),this,VILLAGE_EYE_VAN);

    }


    private void getVillageList() {
        UserService.getVillageList(EyeScreening.this,this,VILLAGE_LIST_REQUEST_CODE);
    }
                ...
                if (response.isSuccessful()) {
                    ...
                    if (baseResponseModule != null) {
                        if (baseResponseModule.getStatus().equalsIgnoreCase(RestUtils.SUCCESS)){
                            ...
                            Log.d(TAG, "onResponse: "+baseResponseModule.getEyeVanModelList().size());
  ...
  //current_list=ArogyaApplication.getTranslate(this,baseResponseModule.getList_name());
   Log.d(TAG, "onResponse: current_list "+current_list);
                            ...
                            if (!(baseResponseModule.getEyeVanModelList().size() > 0)) {
...
//                                tvEmpty.setVisibility(View.VISIBLE);
                                ...
                                if (page>1) {
                                    if (!(eyeVanModelList.contains(baseResponseModule.getEyeVanModelList()))){

                                    }else {
                                        eyeVanModelList.addAll(baseResponseModule.getEyeVanModelList());
                                        eyeScreenAdapter.notifyDataSetChanged();
                                    }
                                } else {
                                    eyeVanModelList.addAll(baseResponseModule.getEyeVanModelList());
                                    eyeScreenAdapter = new EyeScreenAdapter(EyeScreening.this,eyeVanModelList);
                                    rv_eye_van_recyclerview.setAdapter(eyeScreenAdapter);
                                }
                                rv_eye_van_recyclerview.setVisibility(View.VISIBLE);
//                                tvEmpty.setVisibility(View.GONE);

                            } Log.d(TAG, "onResponse: setadpetr"+baseResponseModule.getEyeVanModelList().toString());
...
//                            tvEmpty.setVisibility(View.GONE);
                            ...
                            villageListAdapter = new EyeScreenVillAdapder(EyeScreening.this,baseResponseModule.getVillageListModelList());
    ...
    public void onClick(View view) {
        switch (view.getId()){//0:Adults, 1:Kids
            case R.id.tv_adult:
                flag=0;
                Log.d(TAG, "onClick:tv_adult ");
                updateUi();
                break;
            case R.id.tv_kids:
                flag=1;
                Log.d(TAG, "onClick:tv_kids ");
//                eyeVanModelList.clear();
                updateUi();
//                getVillageTreatmentList(v_id);
                break;

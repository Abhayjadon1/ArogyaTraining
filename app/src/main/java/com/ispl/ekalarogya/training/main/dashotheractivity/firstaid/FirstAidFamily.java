package com.ispl.ekalarogya.training.main.dashotheractivity.firstaid;
...
import com.ispl.ekalarogya.training.adapters.FirstAidFamilyAdapter;
import com.ispl.ekalarogya.training.adapters.FirstAidFamilyMemberAdapter;
...
public class FirstAidFamily   extends AppCompatActivity implements RetroAPICallback {
    ...
    String searchData;
    private static final String TAG = FirstAidFamily.class.getSimpleName();
    FirstAidFamilyAdapter villageFamilyAdapter;
...
//                startActivity(new Intent(SocialSanitisation.this, Preventive.class));
        ...
        GridLayoutManager gridLayoutManager = new GridLayoutManager(FirstAidFamily.this, 1);
    ...
    private void getVillageChildList() {//1:Member listing with head included , 2:Member listing with head excluded
        UserService.getVillageFamilyMembersList(FirstAidFamily.this,v_id,h_id,"1",this,MEMBER_ANIM_REQUEST_CODE);

    }

    private void getVillageheadList(String v_id) {
        UserService.getVillageHeadList(FirstAidFamily.this,v_id,searchData,page,this,VILLAGE_FAMILY_REQUEST_CODE);
  ...
  //current_list=ArogyaApplication.getTranslate(this,baseResponseModule.getList_name());
   Log.d(TAG, "onResponse: current_list "+current_list);
                            ...
                            if(baseResponseModule.getFamilyMemberListModels().size()>0)
                            {
                                ...
                                firstAidFamilyMemberAdapter = new FirstAidFamilyMemberAdapter(FirstAidFamily.this,id,baseResponseModule.getFamilyMemberListModels());
                            ...
                            }else if(firstAidFamilyMemberAdapter!=null&&firstAidFamilyMemberAdapter.getItemCount()==0){
...
//                                tvEmpty.setVisibility(View.VISIBLE);
                                ...
                                if (page > 1) {
                                    ...
                                    villageMobileList.addAll(baseResponseModule.getVillageFamilyModelList());
                                    villageFamilyAdapter = new FirstAidFamilyAdapter(FirstAidFamily.this,v_id, villageMobileList);
